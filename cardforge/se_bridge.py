...
def write_bundle(campaign="still_hour"):
    ...
    with open(readme_path, "w") as f:
        f.write(
            ...
            "   github.com/CGJennings/strange-eons) and the Arkham Horror LCG\n"
            "   plugin (Toolbox > Manage Plug-ins > Catalog; current external\n"
            "   build via the Barnaby Files guide / Mythos Busters Discord,\n"
            "   plus the AH font pack).\n"
